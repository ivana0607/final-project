    ...
    return (<>
        ...
        <div className="log-reg-wrapper">
            <form className="log-reg-form" onSubmit={RegisterNewAccount}>
                <input type="text" placeholder="Write your name..." name="Name" required={true} onInput={setParam} />
                <input type="text" placeholder="Write your surname..." name="Lastname" required={true} onInput={setParam} />
                ...
                <input type="password" placeholder="Confirm password" name="re-password" minLength="8" required={true} onInput={(e) => { e.target.setCustomValidity(e.target.value !== password ? "password must match" : ""); }} />
